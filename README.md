...
| ⚡ [**SHMiner**](https://github.com/OlexiyOdarchuk/Student-Hryvnia-Miner)<br><img src="https://img.shields.io/github/stars/OlexiyOdarchuk/Student-Hryvnia-Miner?style=flat-square&color=00ffcc&labelColor=16161E&logo=github" /> <img src="https://img.shields.io/github/v/release/OlexiyOdarchuk/Student-Hryvnia-Miner?style=flat-square&color=8A2BE2&labelColor=16161E" /> | Cross-platform desktop miner. Rewrote SHA-256 from JS to Go with a goroutine worker pool, then moved the nonce hot loop into a native **Rust** core — SHA-256 straight through the compression function, on hardware SHA instructions (SHA-NI on x86-64, sha2 on ARM). **2000× the hashrate** of the official client on identical hardware. | `Go` `Rust` `Wails` `Svelte` `WebSockets` |
